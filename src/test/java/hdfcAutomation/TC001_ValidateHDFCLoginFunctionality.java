...
public class TC001_ValidateHDFCLoginFunctionality extends base{
...
driver.findElement(By.xpath("//fieldset[@id='yearsIdMD']//div[@placeholder='Years']")).click();
			List<WebElement> options = driver.findElements(By.cssSelector("li[class='ui-select-choices-group'] div[class='ui-select-choices-row ng-scope']"));
		...
		List<WebElement> relatioshipDropdowns = driver.findElements(By.cssSelector("div[class='ui-select-choices-row ng-scope'] span span"));
